...
AutLib::Geo2d_Ellipse::Geo2d_Ellipse
(
...
)
{
	...
	ChangeGeometry() = new Geom2d_TrimmedCurve(geom, geom->FirstParameter(), geom->LastParameter(), theSense);
}
