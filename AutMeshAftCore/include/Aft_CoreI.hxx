...
namespace AutLib
{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::RemoveEntitiesFromGeometry()
	{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	Standard_Boolean Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::IsOnLevel
	(
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	Standard_Boolean Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::GetFrontEntity()
	{
		front_ptr entity;
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	Standard_Boolean Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::IsBelongToFront() const
	{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	Standard_Boolean Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::ChackDistCriteria
	(
		const std::vector<front_ptr>& theFronts
	) const
	{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	Standard_Boolean Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::IsSameLevelFueled()
	{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	Standard_Boolean Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::IsNextLevelFueled()
	{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	Standard_Boolean Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::IsCavityRemoverFueled()
	{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	Standard_Boolean Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::IsNewPointCandidate
	(
		const std::vector<front_ptr>& theEffectives
	) const
	{
		if (frontInfo::AlgCondition() IS_EQUAL Aft_AlgCondition_Repair)
		{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::CalcElementSize()
	{
		Debug_Null_Pointer(frontInfo::CurrentFront());
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::CalcLocalFrontRadius()
	{
		Debug_Null_Pointer(frontInfo::CurrentFront());
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::SetDepthSearching()
	{
		Debug_Null_Pointer(theMetricMap_);
		const auto& sizeMap = *theMetricMap_;
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::AddOptimumNodeTo
	(
		std::vector<node_ptr>& theNodes
	)
	{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::SortNodes
	(
		std::vector<node_ptr>& theNodes
	) const
	{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::RemoveCurrentFromFront() const
	{
		Debug_Null_Pointer(frontInfo::CurrentFront());
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::RetrieveEffectiveFronts
	(
		const std::vector<front_ptr>& theEntities, 
		std::vector<front_ptr>& theEffectives
	) const
	{
		if (frontInfo::AlgCondition() IS_EQUAL Aft_AlgCondition_Repair)
		{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::RetrieveEarlyNodes
	(
		std::vector<node_ptr>& theNodes
	) const
	{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::NodesInRadius
	(
		const Standard_Real theRadius,
		const Point & theCoord, 
		const std::vector<node_ptr>& theNodes,
		std::vector<node_ptr>& theInners
	) const
	{
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::RejectCurrent
	(
	...
	template<class OptNodeAlg, class AftMetricPrcsr, class FrontInfo, class FrontData>
	void Aft_Core<OptNodeAlg, AftMetricPrcsr, FrontInfo, FrontData>::RegisterElement()
	{
