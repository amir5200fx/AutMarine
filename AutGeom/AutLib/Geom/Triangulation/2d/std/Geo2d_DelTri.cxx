...
AutLib::Geo2d_DelTri::Geo2d_DelTri
(
...
void AutLib::Geo2d_DelTri::Import
(
	const std::vector<Pnt2d>& thePts
)
{
...
void AutLib::Geo2d_DelTri::Delaunay()
{
	auto v1 = NbPoints() + 1;
	auto v2 = NbPoints() + 2;
	auto v3 = NbPoints() + 3;
	...
	{
		FatalErrorIn("void AutLib::Geo2d_DelTri::Delaunay()")
...
void AutLib::Geo2d_DelTri::Triangulate()
{
	auto& Pts = Data()->Points();
