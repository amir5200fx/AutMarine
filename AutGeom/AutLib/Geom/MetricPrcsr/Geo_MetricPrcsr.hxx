...
namespace AutLib
{
	...
	public:
		...
		typedef typename vec_type_from_point<Point>::vcType vcType;
		...
		Standard_Real Integrand(const Point& thePoint, const vcType& theVcetor) const;

		Standard_Real IntegrandPerSize(const Point& thePoint, const Point& theVector) const;

		Standard_Real IntegrandPerSize(const Point& thePoint, const vcType& theVcetor) const;
	};
