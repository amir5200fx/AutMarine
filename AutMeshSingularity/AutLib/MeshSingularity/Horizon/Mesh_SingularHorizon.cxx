...
Standard_Boolean AutLib::Mesh_SingularHorizon::IsLoaded() const
{
	return (Standard_Boolean)theMetric_;
}

Standard_Boolean AutLib::Mesh_SingularHorizon::HasHorizon() const
{
	if (NOT IsDone())
	{
		FatalErrorIn("Standard_Boolean AutLib::Mesh_SingularHorizon::HasHorizon() const")
...
Standard_Integer AutLib::Mesh_SingularHorizon::NbHorizons() const
{
	if (NOT IsDone())
	{
		FatalErrorIn("Standard_Integer AutLib::Mesh_SingularHorizon::NbHorizons() const")
			<< "the algorithm is not performed!" << endl
			<< abort(FatalError);
	}
...
AutLib::Mesh_SingularHorizon::Horizon
(
...
void AutLib::Mesh_SingularHorizon::Perform()
{
	if (NOT IsLoaded())
	{
		FatalErrorIn("void AutLib::Mesh_SingularHorizon::Perform()")
