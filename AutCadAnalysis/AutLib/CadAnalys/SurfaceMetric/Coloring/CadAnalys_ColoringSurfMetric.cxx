...
namespace AutLib
{
	...
	typedef CadAnalys_ColoringSurfMetric::elementColor elementColor;
...
Standard_Integer
AutLib::CadAnalys_ColoringSurfMetric::Value
(
...
void AutLib::CadAnalys_ColoringSurfMetric::Perform()
{
	if (NOT theApprox_)
	{
		FatalErrorIn("void AutLib::Geo_ColoringSurfMetric::Perform()")
