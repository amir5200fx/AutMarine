...
//
//AutLib::CadAnalys_ApprxSurfMetricBase::CadAnalys_ApprxSurfMetricBase()
//	: theMaxDet_(0)
...
//		const std::shared_ptr<Geo_SizeFunction<Pnt3d>>& theSizeMap,
//		CadAnalys_ApprxSurfMetricInfo& theInfo,
...
//		{
//			obj =
//				std::make_shared<SpaceApprx_SurfaceObject<Geo_SizeFunction<Pnt3d>>>
//				(
//					*theSurface,
//					theSizeMap,
//					theInfo.Tolerance(),
...
//
//void AutLib::CadAnalys_ApprxSurfMetric::Perform()
//{
//	if (NOT theSurface_)
//	{
