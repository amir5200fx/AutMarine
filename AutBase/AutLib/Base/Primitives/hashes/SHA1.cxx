...
void AutLib::SHA1::processBytes(const void *data, size_t len)
{
...
void AutLib::SHA1::processBlock(const void *data, size_t len)
{
...
void AutLib::SHA1::calcDigest(SHA1Digest& dig) const
{
...
AutLib::SHA1Digest AutLib::SHA1::digest() const
{
	SHA1Digest dig;
