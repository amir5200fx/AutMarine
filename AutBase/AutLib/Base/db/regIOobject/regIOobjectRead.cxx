...
AutLib::Istream& AutLib::regIOobject::readStream()
{
	if (IFstream::debug)
	{
...
AutLib::Istream& AutLib::regIOobject::readStream(const word& expectName)
{
	if (IFstream::debug)
	{
...
bool AutLib::regIOobject::readData(Istream&)
{
	return false;
}


bool AutLib::regIOobject::read()
{
...
bool AutLib::regIOobject::modified() const
{
	return
		(
			lastModified_
...
bool AutLib::regIOobject::readIfModified()
{
	if (lastModified_)
	{
