...
bool AutLib::entry::getKeyword(keyType& keyword, Istream& is)
{
	token keywordToken;
...
bool AutLib::entry::New(dictionary& parentDict, Istream& is)
{
...
AutLib::autoPtr<AutLib::entry> AutLib::entry::New(Istream& is)
{
