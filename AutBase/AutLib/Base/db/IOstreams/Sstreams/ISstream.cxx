...
char AutLib::ISstream::nextValid()
{
	char c = 0;
...
AutLib::Istream& AutLib::ISstream::read(token& t)
{
...
AutLib::Istream& AutLib::ISstream::read(char& c)
{
	c = nextValid();
	return *this;
}
...
AutLib::Istream& AutLib::ISstream::read(word& str)
{
...
AutLib::Istream& AutLib::ISstream::read(string& str)
{
	static const int maxLen = 1024;
	static const int errLen = 80; // truncate error message for readability
	static char buf[maxLen];
...
AutLib::Istream& AutLib::ISstream::read(label& val)
{
	is_ >> val;
	setState(is_.rdstate());
	return *this;
...
AutLib::Istream& AutLib::ISstream::read(floatScalar& val)
{
	is_ >> val;
	setState(is_.rdstate());
	return *this;
...
AutLib::Istream& AutLib::ISstream::read(doubleScalar& val)
{
	is_ >> val;
	setState(is_.rdstate());
	return *this;
...
AutLib::Istream& AutLib::ISstream::read(longDoubleScalar& val)
{
	is_ >> val;
	setState(is_.rdstate());
	return *this;
...
// read binary block
AutLib::Istream& AutLib::ISstream::read(char* buf, std::streamsize count)
{
	if (format() != BINARY)
	{
...
AutLib::Istream& AutLib::ISstream::rewind()
{
...
std::ios_base::fmtflags AutLib::ISstream::flags() const
{
	return is_.flags();
}


std::ios_base::fmtflags AutLib::ISstream::flags(const ios_base::fmtflags f)
{
	return is_.flags(f);
}