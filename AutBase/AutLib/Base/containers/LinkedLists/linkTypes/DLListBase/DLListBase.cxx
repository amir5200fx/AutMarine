...
AutLib::DLListBase::iterator AutLib::DLListBase::endIter_
(
	const_cast<DLListBase&>(static_cast<const DLListBase&>(DLListBase()))
);

AutLib::DLListBase::const_iterator AutLib::DLListBase::endConstIter_
(
	static_cast<const DLListBase&>(DLListBase()),
	reinterpret_cast<const link*>(0)
);

void AutLib::DLListBase::insert(DLListBase::link* a)
{
	nElmts_++;
...
void AutLib::DLListBase::append(DLListBase::link* a)
{
	nElmts_++;
...
bool AutLib::DLListBase::swapUp(DLListBase::link* a)
{
	if (first_ != a)
	{
		link* ap = a->prev_;
...
bool AutLib::DLListBase::swapDown(DLListBase::link* a)
{
	if (last_ != a)
	{
		link* an = a->next_;
...
AutLib::DLListBase::link* AutLib::DLListBase::removeHead()
{
	nElmts_--;
...
AutLib::DLListBase::link* AutLib::DLListBase::remove(DLListBase::link* l)
{
	nElmts_--;
...
AutLib::DLListBase::link* AutLib::DLListBase::replace
(
