...
) const
{
	...
	theC1 = std::make_shared<GModel_parCurve>(FirstParam(), x, Curve(), Info());
	theC2 = std::make_shared<GModel_parCurve>(x, LastParam(), Curve(), Info());
}
...
) const
{
	...
	theC1 = std::make_shared<GModel_parCurve>(left->FirstParameter(), left->LastParameter(), left, Info());
	theC2 = std::make_shared<GModel_parCurve>(right->FirstParameter(), right->LastParameter(), right, Info());
}
