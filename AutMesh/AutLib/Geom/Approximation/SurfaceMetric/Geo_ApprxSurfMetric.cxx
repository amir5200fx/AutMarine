...
//
//		mutable Standard_Real MaxDeterminat;
//
...
//
//			if (d0 > obj.MaxDeterminat) obj.MaxDeterminat = d0;
//			if (d1 > obj.MaxDeterminat) obj.MaxDeterminat = d1;
//			if (d2 > obj.MaxDeterminat) obj.MaxDeterminat = d2;
//			if (d3 > obj.MaxDeterminat) obj.MaxDeterminat = d3;
//
...
//			auto C = D1V.Dot(D1V);
//
//			const auto h = Map()->CalcElementSize(theCoord);
...
//		const std::shared_ptr<Mesh_SurfaceSizeMap<Mesh3d_SizeMap>>& theSizeMap,
//		Geo_ApprxSurfMetricInfo& theInfo,
//		std::shared_ptr<SpaceApprx_SurfaceObjectBase>& obj,
//		Standard_Real& maxDet
//	)
//	{
//
//		if (theSizeMap)
//		{
//			obj =
//				std::make_shared<SpaceApprx_SurfaceObject<Mesh_SurfaceSizeMap<Mesh3d_SizeMap>>>
//				(
//					*theSurface,
//					theSizeMap,
//					theInfo.Tolerance(),
...
//
//		maxDet = obj->MaxDeterminat;
//
//		auto maxInvDet = (Standard_Real)1.0 / obj->MaxDeterminat;
//
