...
namespace AutLib
{
	...
	Mesh2d_Element::array3 Mesh2d_Element::InterpWeights(const Pnt2d& theCoord) const
	{
		...
		auto A1 = Processor::Area_cgal(node1.Coord(), node2.Coord(), theCoord);
		auto A2 = Processor::Area_cgal(node2.Coord(), node0.Coord(), theCoord);
		auto A3 = Processor::Area_cgal(node0.Coord(), node1.Coord(), theCoord);
